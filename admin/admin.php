...
<hr class="line" style=" border:2px solid">
      <dl >   
        <dd class="side-links text-center "> <a href="NGO_Registeration.php">Add NGO</a></dd>
         <dd class="side-links text-center"> <a href="Display.php">Manage NGOs</a></dd>
         <dd class="side-links text-center"><a href="addCat.php">Add Category</a></dd>
          <dd class="side-links text-center"><a href="adduser.php">Add User</a></dd>
          <dd class="side-links text-center"><a href="view-user.php">View Users</a></dd>
          <dd class="side-links text-center"><a href="TransHistory.php">View Transaction</a></dd>
        ...
        if (isset($_POST['search_btn'])) {
            ...
            if (mysqli_num_rows($query_run) > 0) {
                while ($row = mysqli_fetch_assoc($query_run)) {
                    ...
                    $shortDescription = substr($discreption, 0, 380);
                            ...
                            <div class="col">
                                <div class="card m-3">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-2 "> <button class="btn btn-primary" ><a style="text-decoration:none" href="donate.php? updateid='.$id.'" class="text-light">Donate Online</a></button><br>
